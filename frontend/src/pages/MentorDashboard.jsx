  ...
  <div style={{ display: "flex", gap: "0.6rem", flexWrap: "wrap", marginTop: "0.4rem" }}>
    {s.files.map((file, idx) => {
      ...
      return (
        <>
          {/* View */}
          <a key={`view-${idx}`} href={file} target="_blank" rel="noreferrer"
          ...
          {/* Download */}
          <a key={`dl-${idx}`} href={file} download
            style={{ fontSize: "0.8rem", color: "#059669", background: "#d1fae5",
              padding: "0.2rem 0.6rem", borderRadius: "8px", textDecoration: "none" }}>
            ⬇️ Download
          </a>
        </>
                        ...
                        {/* Submitted time */}
                        <p style={{ color: "#d1d5db", fontSize: "0.78rem", marginTop: "0.3rem" }}>
